                            ...
                            <div class="nk-block-head-content">
                                ...
                                <nav>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="#">Saldo Masuk</a></li>
                                    </ul>
                                </nav>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="/admin/report/balance-in/detail" class="text-info"><em class="icon ni ni-eye"></em><span>Detail</span></a></li>
