                            ...
                            <div class="nk-block-head-content">
                                ...
                                <nav>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">Saldo Keluar</li>
                            ...
                            <div class="card-inner">
                                <div class="card-title-group">
                                    <div class="card-title">
                                        <h6 class="title">Detail Saldo Keluar</h6>
                                    </div>
                                ...
                                <div class="row gy-4">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="transaction" value="Pulsa TSEL 100.000" placeholder="" readonly>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="col-12">
                                        <ul class="align-center flex-wrap flex-sm-nowrap gx-4 gy-2">
                                            <li>
                                                <a href="/admin/report/balance-out" class="btn btn-lg btn-light">Kembali</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
