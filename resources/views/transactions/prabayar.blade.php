                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">PPOB Prabayar</h3>
                                <nav>
                                    <ul class="breadcrumb">
                                        <li class="breadcrumb-item">Home</li>
                                        <li class="breadcrumb-item">Transaction</li>
                                        <li class="breadcrumb-item active"><a href="#">PPOB Prabayar</a></li>
                                    </ul>
                                </nav>
                            ...
                            <div class="col-xxl-12">
                                <div class="card card-bordered card-preview">
                                    <div class="card-inner">
                                        <div class="card-title-group">
                                            <div class="card-title">
                                                <h6 class="title">PPOB Prabayar Transaction</h6>
                                            </div>
                                        ...
                                        <table class="datatable-init table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="/transaction/ppob-prabayar/detail" class="btn btn-icon btn-info mb-1 me-1"><em class="icon ni ni-eye-alt"></em></a>
