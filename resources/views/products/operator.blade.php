                ...
                <div class="nk-content-body">
                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="card card-bordered card-preview">
                            <div class="card-inner">
                                <div class="card-title-group">
                                    <div class="card-title">
                                        <h6 class="title">Operator</h6>
                                    </div>
                                    <div class="card-tools me-n1">
                                        <ul class="btn-toolbar gx-1">
                                            <li class="align-center">
                                                <a href="/admin/product/operator/add" class="btn btn-sm btn-primary"><em class="icon ni ni-plus-sm"></em><span class="d-none d-md-block">Tambah Operator</span></a>
                                            </li><!-- li -->
                                            <li>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                        <div class="dropdown-head bg-primary">
                                                            <span class="sub-title dropdown-title text-white">Filter Operator</span>
                                                        </div>
                            ...
                            <div class="card-inner">
                                <table class="datatable-operator table">
                                    ...
                                    <tbody class="align-middle">
                                        <tr>
                                            ...
                                            <td>0815,0812</td>
                                            <td></td>
                                            <td><span class="badge badge-dim rounded-pill bg-outline-primary">Prabayar</span></td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="/admin/product/operator/edit" class="text-primary"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
    ...
    <script>
        !function (NioApp, $){
            NioApp.DataTable.init = function () {
                NioApp.DataTable('.datatable-operator', {
                    responsive: {
                        details: true
                    },
                    language: {
