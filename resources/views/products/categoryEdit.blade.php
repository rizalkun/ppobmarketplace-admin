                                    ...
                                    <div class="card-inner">
                                        <form action="/admin/product/category">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-lg" name="product_id" id="p_id" value="" placeholder="Enter Product Id" readonly>
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="p_name">Product Name</label>
                                                <input type="text" class="form-control form-control-lg" name="product_name" id="p_name" value="" placeholder="Enter Product Name">
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label">Type</label>
                                                <select class="form-select js-select2" data-ui="lg" name="is_prabayar">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-select js-select2" data-ui="lg" name="status">
