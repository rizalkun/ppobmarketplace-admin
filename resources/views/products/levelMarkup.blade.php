                ...
                <div class="nk-content-body">
                            ...
                            <div class="nk-block-head-content">
                                ...
                                <nav>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="#">Level Markup</a></li>
                                    </ul>
                                </nav>
                    ...
                    <div class="nk-block nk-block-lg">
                        <div class="card card-bordered card-preview">
                            <div class="card-inner">
                                <div class="card-title-group">
                                    <div class="card-title">
                                        <h6 class="title">Level Markup Management</h6>
                                    </div>

                                    <div class="card-tools me-n1">
                                        <ul class="btn-toolbar gx-1">
                                            <li class="align-center">
                                                <a href="/admin/product/level-markup/add" class="btn btn-sm btn-primary"><em class="icon ni ni-plus-sm"></em><span class="d-none d-md-block">Tambah Produk Level</span></a>
                                            </li><!-- li -->
                                            <li>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="filter-wg dropdown-menu dropdown-menu-xl dropdown-menu-end">
                                                        <div class="dropdown-head bg-primary">
                                                            <span class="sub-title dropdown-title text-white">Filter Level</span>
                                                        </div>
                            ...
                            <div class="card-inner">
                                <table class="datatable-level table">
                                    ...
                                    <tbody class="align-middle">
                                        <tr>
                                            <td>TSEL 100.000_GIFT</td>
                                            <td>All User</td>
                                            <td>Rp 300</td>
                                            <td><span class="badge badge-dim rounded-pill bg-outline-success">Active</span></td>
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <ul class="link-list-opt no-bdr">
                                                            <li><a href="/admin/product/level-markup/edit" class="text-primary"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
    ...
    <script>
        !function (NioApp, $){
            NioApp.DataTable.init = function () {
                NioApp.DataTable('.datatable-level', {
                    responsive: {
                        details: true
                    },
                    language: {
